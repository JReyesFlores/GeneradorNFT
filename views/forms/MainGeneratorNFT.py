...
class FileNFTModel(): 
    default_path_file = 'D:\\ZEGEL\\2.DO_CICLO\\Estructura de Datos\\ProyectoFinal2\\views\\assets\\news_nft'
...
class NFTLogic():
    ...
    def generate_art(self, newFileNFT: FileNFTModel):
        ...
        image.save(f'{FileNFTModel.default_path_file}\\{newFileNFT.getNombreNFT()}.png')
        print('Arte creado!')
...
class Ui_MainGeneradorNFT(object):
    ...
    def ListarNFT(self):
        ...
        for item in self.ListaNFTs:
            strArchivo = f'{FileNFTModel.default_path_file}\\{item.getNombreNFT()}.png'
    ...
    def validacion_individual(self):
        self.msgBoxDialog('Prueba 2', False)
